...
const Registration = () => {
  ...
  const handleLocationChange = (e) => {
    ...
    if (checked) setLocations([...locations, value]);
    else setLocations(locations.filter(loc => loc !== value));
  }
  ...
  const handleSubmit = async (e) => {
    ...
    const registrationData = {  fname,phoneNumber,email, password, locations, description };
  ...
  return (
    <div className='wrapper'>
      <form onSubmit={handleSubmit}>
        ...
        <textarea className='desc-input' placeholder='اضف بعض التفاصيل عن عملك (أنواع البضائع التي تنقلها .....)' value={description} onChange={e => setDescription(e.target.value)} />
